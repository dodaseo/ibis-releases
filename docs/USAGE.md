...
한국어로 연구하는 사람을 위한 **문헌 관리 앱**. **찾기 → 원문 확보 → 읽기·AI 분석 → 정리·태그 그래프 → 동료와 나누기** 까지 한 프로그램 안에서 합니다. 아래아한글·Word 본문 인용(CWYW)도 그중 한 기능입니다. 기준 버전 **2026.9.1**.
...
| **레일**(맨 왼쪽) | 라이브러리 · 외부 검색 · **질문으로 찾기** · 그래프 뷰 전환, 아래쪽에 참고문헌 갱신 · **인용 편집 창** · 휴지통 · **⚙설정**(맨 아래) |
