...
최신 기록 **2026-08-10** · 누적 합계 **134건** (설치 14 · zip 25)

```mermaid
xychart-beta
    title "누적 다운로드 — 설치 프로그램 / 무설치 zip"
    x-axis [07-29, 07-30, 07-31, 08-01, 08-02, 08-03, 08-04, 08-05, 08-07, 08-08, 08-09, 08-10]
    y-axis "건수" 0 --> 31
    line [8, 9, 9, 9, 9, 9, 9, 9, 10, 14, 14, 14]
    line [19, 20, 20, 20, 20, 20, 20, 21, 22, 23, 24, 25]
```
