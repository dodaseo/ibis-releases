...
최신 기록 **2026-08-07** · 누적 합계 **104건** (설치 10 · zip 22)

```mermaid
xychart-beta
    title "누적 다운로드 — 설치 프로그램 / 무설치 zip"
    x-axis [07-29, 07-30, 07-31, 08-01, 08-02, 08-03, 08-04, 08-05, 08-07]
    y-axis "건수" 0 --> 27
    line [8, 9, 9, 9, 9, 9, 9, 9, 10]
    line [19, 20, 20, 20, 20, 20, 20, 21, 22]
```
