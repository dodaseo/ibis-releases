...
## 주요 기능
**두 가지 찾기 — 키워드로, 질문으로**
- **키워드로 찾기** — 낱말로 좁혀 찾습니다(레일 두 번째). 찾기 줄 아래 체크 행에서 DB 를 골라 여러 곳을 한 번에 질의하고 중복을 합칩니다
- **질문으로 찾기** — 낱말이 아니라 **연구 질의를 문장으로** 던지면 국내외 학술 DB 를 뒤져 **관련도 순위**로 돌려줍니다(레일 세 번째). 결과는 키워드로 찾기와 **같은 표**에 나오고, 관련도 칸이 하나 더 붙습니다
...
최신 기록 **2026-09-07** · 누적 합계 **438건** (설치 21 · zip 58)
