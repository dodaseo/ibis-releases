...
| 0.5.0 | 이전 배포판 | SQLite 백엔드 · 내 서지 광역 전문검색(FTS) |
| **v0.5.5** | **현재 배포판** | 언어×유형 인용 서식 · 문서별 스타일 · 서지 직접 추가 · 프레임리스 커스텀 타이틀바·항상 위 고정 · 온보딩 · AI 폴백 |
| 0.6.0 | 준비 중 | 인앱 PDF 뷰어·주석(하이라이트·밑줄·메모) |
