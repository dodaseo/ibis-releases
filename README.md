...
| **내 서재 전체 동기화** | 계정 기반 동기화는 **컬렉션 단위까지 나왔습니다**(위 컬렉션 공유). 서재 전체를 여러 PC 에서 맞추는 것은 아직 클라우드 폴더에 얹는 방식이고, 계정 기반으로 넓히는 것을 검토합니다. |
