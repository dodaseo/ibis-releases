...
## 주요 기능
**질문으로 찾기** (2026.9.1)
- 낱말이 아니라 **연구 질의를 문장으로** 던지면 국내외 학술 DB 와 내 서재를 한 번에 뒤져 **관련도 순위**로 돌려줍니다(레일 세 번째)
- 검색 대상 선택: `전체` │ `내 서재` │ 국내(KCI·ScienceON·국립중앙도서관) │ 국외(OpenAlex·Crossref·ERIC·arXiv)
...
최신 기록 **2026-09-05** · 누적 합계 **369건** (설치 17 · zip 48)
