...
| 버전 | 상태 | 비고 |
|---|---|---|
| 0.3.0 ~ 0.5.x | 이전 배포판 | 첫 베타(Qt) → 새 웹 UI · 스마트 컬렉션 · 태그 그래프 · SQLite 전문검색 · 언어×유형 인용 서식 · 문서별 스타일 |
| 0.6.x | 이전 배포판 | 인앱 PDF 뷰어·주석(하이라이트·밑줄·메모) · 주석 모아보기 · 주석 포함 인쇄 |
| 0.7.x | 이전 배포판 | 원문 URL 직행(RISS 재현) · 다중 제공처 · 연결 안 된 PDF 관리 · 진행률/남은 시간 |
| 2026.7.0 | 이전 배포판 | 테마 16종 · 글꼴 선택/내려받기 · AI CLI 설치·로그인 안내 · 라이선스 고지 · 버전 체계 CalVer 전환 |
| **v2026.7.1** | **현재 배포판** | 설치 프로그램(setup.exe) 배포 시작 · 설정 조작 문제 수정 · 사용 설명서·FAQ 개편 |
