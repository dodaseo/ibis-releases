...
- 기록 시작 **2026-07-29** · 최신 스냅숏 **2026-09-14** · 스냅숏 45개
...
| 구분 | 누적 | 전일 대비 |
|---|---:|---:|
| 설치 프로그램 (새 설치에 가깝다) | 34 | +3 |
| 무설치 zip (+ 인앱 업데이트) | 78 | +6 |
| 체크섬 (앱이 켜질 때마다 1 — 아래 '사용 현황') | 453 | +19 |
| **합계** | **565** | |
...
- 최근 7일 평균 **하루 13회** · 전체 기간 평균 하루 10회 · 마지막 관측 **19회**(2026-09-14)
